...
__EmojiPoll__ [(website)](https://emojipoll.haryadi.my.id) is a tool for creating polls using random emoji. Just fill in the entries, copy the poll text and paste it on your favorite reaction-featured instant-messaging app.  
